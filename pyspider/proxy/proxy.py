...
class ProxyPool:
    ...
    def validate_proxy(self, proxy: Proxy, test_url: str = "https://www.google.com", timeout: int = 10) -> bool:
        """验证代理"""
        try:
            proxies = {
                "http": proxy.url,
    ...
    def validate_all(self, test_url: str = "https://www.google.com", timeout: int = 10) -> int:
        """验证所有代理"""
        valid_count = 0
        with self._lock:
            for proxy in self._proxies:
