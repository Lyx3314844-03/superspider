...
class SmartParser:
    ...
    def _extract_title(self) -> Optional[str]:
        ...
        selectors = [
            ...
            '.title', '.article-title', '.product-title',
    ...
    def _extract_description(self) -> Optional[str]:
        ...
        selectors = [
            ...
            '.description', '.summary', '[itemprop="description"]',
        ]
    ...
    def _extract_main_text(self) -> str:
        ...
        selectors = [
            ...
            '[itemprop="articleBody"]', '.post-content',
        ]
    ...
    def _extract_price(self) -> Optional[str]:
        """提取价格"""
        selectors = [
            '.price', '[itemprop="price"]', 'meta[property="product:price:amount"]',
    ...
    def _extract_views(self) -> Optional[int]:
        """提取观看次数"""
        selectors = [
            '.views', '.view-count', '[itemprop="interactionCount"]',
        ]
    ...
    def _extract_category(self) -> Optional[str]:
        """提取分类"""
        selectors = [
            '.category', '.categories a', '[itemprop="articleSection"]',
    ...
    def _extract_reviews_count(self) -> Optional[int]:
        """提取评论数"""
        selectors = [
            '.reviews-count', '[itemprop="reviewCount"]',
