...
from .graph_builder import Node, Edge, GraphBuilder
                ...
                if parent_node:
                    relations.append({
                        ...
                        'parent': {
                            ...
                            'text': parent_node.text[:100] if parent_node.text else '',
                        },
                        'child': {
                            'id': node_id,
                            'tag': node.tag,
                    ...
                    'nodes': [
                        {
                            ...
                            'text': children[i].text[:50] if children[i].text else '',
                        },
                        {
                            'id': children[i+1].id,
                            'tag': children[i+1].tag,
                            'type': children[i+1].type,
                            'text': children[i+1].text[:50] if children[i+1].text else '',
                        },
                    ],
                    'parent_id': parent_id,
                })
