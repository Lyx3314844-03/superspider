...
try:
    from playwright.sync_api import sync_playwright, Page, Browser, BrowserContext, Playwright, Route, Request, Response, Geolocation
...
class PlaywrightBrowserAdvanced:
    ...
    def _apply_advanced_stealth_mode(self):
        ...
        self.page.add_init_script("Object.defineProperty(screen, 'pixelDepth', {get: () => 24})")
        self.page.add_init_script("Object.defineProperty(navigator, 'vendor', {get: () => 'Google Inc.'})")
    ...
    def _setup_performance_monitoring(self):
        ...
        def on_request(request: Request):
            ...
            self.metrics.resource_types[resource_type] = self.metrics.resource_types.get(resource_type, 0) + 1
    ...
    def navigate_and_wait(self, url: str, selector: Optional[str] = None, max_retries: int = 3) -> Page:
        """导航并等待内容加载"""
    ...
    def screenshot_region(self, x: int, y: int, width: int, height: int, path: str):
        ...
        self.page.screenshot(path=str(region_path), clip={'x': x, 'y': y, 'width': width, 'height': height})
    ...
    def intercept_and_modify_request(self, url_pattern: str, header_name: str, header_value: str):
        """拦截并修改请求"""
        self._ensure_started()
